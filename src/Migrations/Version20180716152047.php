 ...
 */
final class Version20180716152047 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE broadcasts (id INT AUTO_INCREMENT NOT NULL, org_id INT NOT NULL, usr_name VARCHAR(30) NOT NULL, scheduled DATETIME DEFAULT NULL, short_msg VARCHAR(140) NOT NULL, long_msg VARCHAR(2048) DEFAULT NULL, rev INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_D64238E4F4837C1B (org_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE carriers (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, gateway VARCHAR(50) NOT NULL, rev INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contacts (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, contact VARCHAR(50) NOT NULL, carrier_id INT DEFAULT NULL, rev INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, UNIQUE INDEX UNIQ_334015734C62E638 (contact), INDEX IDX_33401573A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE org_members (id INT AUTO_INCREMENT NOT NULL, org_id INT NOT NULL, user_id INT NOT NULL, is_admin TINYINT(1) NOT NULL, is_approved TINYINT(1) NOT NULL, is_blocked TINYINT(1) NOT NULL, alt_usr_name VARCHAR(30) DEFAULT NULL, rev INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_36DF8631F4837C1B (org_id), INDEX IDX_36DF8631A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
